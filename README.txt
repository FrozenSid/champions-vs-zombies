...
- save all the files from here (my github repository champions-vs-zombies) in one folder and name it anything you want
  (for example, "CvsZ")
- put that "CvsZ" folder in the "htdocs" or "www" directory when you open your WAMP, LAMP, MAMP folder
- run WAMP/LAMP/MAMP (if the icon is green everything works fine)
- open a web browser and type "localhost:8888/CvsZ" and you will see the website
